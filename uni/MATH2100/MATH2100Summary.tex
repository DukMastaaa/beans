...
\begin{multicols}{2}
    ...
    are mutually orthogonal by integration and sum/difference identities.
    Both sides of the Fourier Series equation can then be integrated and solved for
    the coefficients, where orthogonal terms vanish. Note that ``orthogonal'' is in the context
    of inner product spaces, discussed further in MATH2001.
    ...
    The rest of the course only considers these equations in detail.
